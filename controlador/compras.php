...
<br>
<div class="container">
<a href="registroCompras.php" class="btn btn-primary mb-3">Agregar productos</a>
  ...
  <tbody>
   ...
   <?php
    ...
    <tr>
      ...
      <td>
       <a href="../paginas/Vista_EditarCompra.php?ID=<?php echo $fila['ID']?>" class="btn btn-warning">editar</a>
       <a href="controlador_EliminarCompra.php?ID=<?php echo $fila['ID']?>" class="btn btn-danger">eliminar</a> 
      </td>
    </tr>
  </tbody>

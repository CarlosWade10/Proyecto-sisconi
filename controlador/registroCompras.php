...
<head>
    ...
    <title>SISCONI - Nueva compra</title>
</head>
<body>
  
<center>
  <h1 class="mt-3">REGISTRO DE LAS COMPRAS</h1>  
</center>
...
<form action="Agregar.php" method="POST" enctype="multipart/form-data" id="form" clase="form">
  ...
  <div class="mb-3 mx-5">
    ...
    <input type="number" class="form-control" id="preCompra" name="PreCompra" placeholder="ingresa el precio de compra" min="0">
  </div>

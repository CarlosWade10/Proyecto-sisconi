  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"> <i class="fa-solid fa-user fa-lg"></i> AGREGAR USUARIO</h5>
...
-->
  ...
  <form action="../controlador/controlador_RegisUsuario.php" method="post" id="formulario">
  <div class="mb-3">
    <label for="nombreProve2" class="form-label">Nombre:</label>
    <input type="text" class="form-control" id="nombreProve2" placeholder="agregar nombre del usuario" require name="NombreUsu" onkeypress="return SoloLetras(event);">
  </div>

  <div class="mb-3">
    <label for="TipoProve2" class="form-label">Apellidos:</label>
    <input type="text" class="form-control" id="TipoProve2" placeholder="agrega los apellidos" require name="ApellidosUsu" onkeypress="return SoloLetras(event);">
  </div>

  <div class="mb-3">
    <label for="NumeroProve2" class="form-label">usuario:</label>
    <input type="text" class="form-control" id="NumeroProve2" placeholder="agrega el usuario" require name="Usuario">
  </div>

  <div class="mb-3">
    <label for="FechaReg2" class="form-label">Contraseña:</label>
    <input type="text" class="form-control" id="FechaReg2" placeholder="agrega la contraseña" require name="ContraUsu">
  </div>
...
<form action="../controlador/controlador_EditarUsuario.php" method="post" id="formulario2">

<input type="hidden" id="IDProveedor" name="IDProveedor" value="0">

   <div class="mb-3">
    <label for="NombreProve" class="form-label">Nombre del usuario:</label>
    <input type="text" class="form-control" id="NombreProve" placeholder="agregar nombre del usuario" require name="NombreUsu" onkeypress="return SoloLetras(event);">
  </div>

  <div class="mb-3">
    <label for="tipoProve" class="form-label">Apellidos:</label>
    <input type="text" class="form-control" id="tipoProve" placeholder="agrega los apellidos" require name="ApellidosUsu" onkeypress="return SoloLetras(event);">
  </div>

  <div class="mb-3">
    <label for="NumeroProve" class="form-label">Usuario:</label>
    <input type="text" class="form-control" id="NumeroProve" placeholder="agrega el usuario" require name="Usuario">
  </div>

  <div class="mb-3">
    <label for="fechaReg" class="form-label">Contraseña:</label>
    <input type="text" class="form-control" id="fechaReg" placeholder="la contraseña" require name="ContraUsu">
  </div>
...
$(tbody).on("click", "button.editar",function(){
  var data = table.row($(this).parents("tr")).data();
   var ID = $('#IDProveedor').val(data.ID),
    ...
    TipoProveedor = $('#tipoProve').val(data.Apellido),
    Numero = $('#NumeroProve').val(data.usuario),
    FechaRegistro = $('#fechaReg').val(data.contraseña);
});
}
...
$(tbody).on("click", "button.eliminar",function(){
  ...
  var id = data['ID'],
  Nombre = data['Nombre'],
  TipoProveedor = data['Apellido'],
  Numero = data['usuario'],
  FechaRegistro = data['contraseña'];
   console.log('El ID de la fila seleccionada es: ' + id +" "+Nombre);
   alertaEliminar(id, Nombre, TipoProveedor, Numero, FechaRegistro);
});
}

function alertaEliminar(ID, nombre, TP, NP, FR){
 Swal.fire({
...
function eliminar_php(codigo){
 ...
 $.ajax({
  data: parametros,
  url: "../controlador/controlador_eliminarUsuario.php",
  type: "POST",
  beforeSend: function(){},
  success: function(){
   Swal.fire({
